...
images = ["/portfolio/bitbucket-pipelines-common-step/bitbucket-pipelines-header.png"]
showonlyimage = false
...
{{< figure src="bitbucket-pipelines-flower.png" title="Bitbucket Pipelines. It... grows in a pot?" >}}
